...
export class BookingsController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Validation errors (e.g. past date, inactive service).',
  })
  @ApiResponse({ status: 404, description: 'Service not found.' })
  @ApiResponse({
    status: 409,
    description: 'Double booking detected for this service at this time.',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Retrieve a paginated list of bookings (Protected)',
  })
  @ApiResponse({
    status: 200,
